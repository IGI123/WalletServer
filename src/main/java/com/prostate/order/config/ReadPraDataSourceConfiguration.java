 ...
 */
@Configuration
@MapperScan(basePackages = "com.prostate.order.mapper.wallet.read", sqlSessionTemplateRef  = "readPraSqlSessionTemplate")
public class ReadPraDataSourceConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("readPraDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:mapping/wallet/read/*.xml"));
